...
public static class Logger
{
    ...
    static Logger()
    {
        // OPENCLAW_APP_DATA_DIR keeps test instances out of the user's log file.
        _logDirectory = Environment.GetEnvironmentVariable("OPENCLAW_APP_DATA_DIR") is { Length: > 0 } overrideDir
            ? overrideDir
            : Path.Combine(
        ...
        _logFilePath = Path.Combine(_logDirectory, "openclaw-app.log");
